...
import nostr_bunker.migrations as ext_migrations  # type: ignore[import]
from nostr_bunker.crud import db  # type: ignore[import]
...
async def init_ext():
    ...
    async with db.connect() as conn:
        await run_migration(conn, ext_migrations, "nostr_bunker")